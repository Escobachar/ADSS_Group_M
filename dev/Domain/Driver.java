...
public class Driver extends GeneralEmployee {
    ...
    public Driver(int ID, String name, String bankAccountDetails, int salary, String startOfEmployment, String partOfJob, int vacationsDays, Branch branch, String password,Network network,
                  String driverLicense,List<String> driverLicenseTypes) {
        List<Role> role = new LinkedList<>();
