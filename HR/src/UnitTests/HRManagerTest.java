...
public class HRManagerTest {
    ...
    public void initTest() {
        ...
        this.hrm = new HRManager(123456788, "Tomer", "123456789", 30, new Date(2024, 4, 31),null,"half", 30);
    ...
    public void addEmployee1() {
        this.hrm.addEmployee(123456789, "Shai Hubashi", "12345678", 500, new Date(2024, Calendar.JANUARY, 31), "Full", 18, this.roles, false, this.branch);
        Assert.assertTrue(branch.isExist(123456789));//changed part of job
    }
    @Test
    public void addEmployee2() {
        this.hrm.addEmployee(123456, "Shai Hubashi", "12345678", 500, new Date(2024, Calendar.JANUARY, 31), "Half", 18, this.roles, false, this.branch);
        Assert.assertFalse(branch.isExist(123456));//incorrect id

    }
    @Test
    public void addEmployee3() {
        this.hrm.addEmployee(123456789, "Shai3", "12345678", 500, new Date(2024, Calendar.JANUARY, 31), "Half", 18, this.roles, false, this.branch);
    ...
    public void addEmployee5() {
        this.hrm.addEmployee(123456789, "Shai Hubashi", "1231231231231223232", 500, new Date(2024, Calendar.JANUARY, 31), "Half", 18, this.roles, false, this.branch);
        Assert.assertFalse(branch.isExist(123456789));//incorrect bankAccountDetails2
    }
    @Test
    public void addEmployee6() {
        this.hrm.addEmployee(123456789, "Shai Hubashi", "12341234s", 500, new Date(2024, Calendar.JANUARY, 31), "Half", 18, this.roles, false, this.branch);
    ...
    public void addEmployee9() {
        this.hrm.addEmployee(123456789, "Shai Hubashi", "12345678", 500, new Date(2024, Calendar.JANUARY, 31), "Half", -1, this.roles, false, this.branch);
    ...
    public void addEmployee11() {
        this.hrm.addEmployee(123456789, "Shai Hubashi", "12345678", 500, new Date(2024, Calendar.JANUARY, 31), "Half", 0, this.roles, false, this.branch);
        this.hrm.addEmployee(123456788, "Tomer Cohen", "12345678", 500, new Date(2024, Calendar.JANUARY, 31), "Half", 0, this.roles, false, this.branch);
    ...
    public void UpdateEmployee0() {
        this.hrm.UpdateEmployee(123456789, "Shai Hubashi change", "12345678", 500, new Date(2024, Calendar.JANUARY, 31) ,null,"Half", 18, this.roles, false, this.branch);
    ...
    public void UpdateEmployee1() {
        this.hrm.addEmployee(123456789, "Shai Hubashi", "12345678", 500, new Date(2024, Calendar.JANUARY, 31), "Half", 0, this.roles, false, this.branch);
        this.hrm.UpdateEmployee(123456789, "Shai Hubashi change", "123456789", 500, new Date(2024, Calendar.JANUARY, 31) ,null,"Half", 18, this.roles, false, this.branch);
