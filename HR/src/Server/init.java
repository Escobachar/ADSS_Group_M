...
public class init {
    public static Network init(boolean init){
        ...
        if(init) {
            ...
            BranchManager bm = new BranchManager(222222222, "Tomer Cohen", "2222222222", 50, new Date(2024, 6, 4), null, "Half", 18,branch,"2222");
            ...
            GeneralEmployee ge2 = hrm.addGeneralEmployee(444444444, "General Employee second", "444444444", 40, new Date(2024, 6, 4), null, "Half", 10, oneRole , false, branch, "4444");
        }
        return network;
    }
}
