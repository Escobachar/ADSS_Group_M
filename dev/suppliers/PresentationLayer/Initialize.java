...
public class Initialize {
        ...
        public Initialize() {
                ...
                l2.add(1);
                l2.add(4);
                ss.addSupplier("Supplier1", 4, "bank1", "payment1", new HashMap<>(),
                                new LinkedList<>(),
                                new HashMap<Category, HashMap<Integer, Product>>(), false, "address1");
                ss.addSupplier("Supplier2", 5, "bank2", "payment2", new HashMap<String, String>(), l2,
                                new HashMap<Category, HashMap<Integer, Product>>(), true, "address2");
                ss.addSupplier("Supplier3", 6, "bank3", "payment3", new HashMap<String, String>(),
                                new LinkedList<Integer>(),
                                new HashMap<>(), true, "address3");
                ss.addSupplierContact(4, "contact1", "123456789");
                ss.addSupplierContact(4, "contact2", "987654321");
                ss.addSupplierContact(5, "contact3", "123456789");
                ...
                try {
                        ...
                        items2.put(2, 5);
                        os.addOrder(4, "20/06/2024", items1, new LinkedList<Integer>());
                        os.addOrder(5, "21/06/2024", items2, new LinkedList<Integer>());
                        LocalDate tomorrow = LocalDate.now().plusDays(1);
                        Date deliveryDate = java.sql.Date.valueOf(tomorrow);
                        SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
                        String formattedDate = dateFormat.format(deliveryDate);
                        os.addOrder(4, formattedDate, items1, new LinkedList<Integer>());
                }
                catch (Exception e){
